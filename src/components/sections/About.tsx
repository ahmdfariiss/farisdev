        ...
        >
          ...
          <div className="lg:col-span-7 order-2 lg:order-1">
            ...
            >
              ...
              <span className="text-xs tracking-[0.3em] text-neutral-500 uppercase">About Me</span>
            </motion.div>
            ...
            >
              <p>
                Saya adalah mahasiswa Ilmu Komputer semester 5 dengan passion yang 
                mendalam dalam pengembangan web dan Internet of Things.
              </p>
              <p>
                Fokus saya adalah menciptakan solusi digital yang tidak hanya 
              ...
              {highlights.map((item, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-neutral-500 text-xs ml-2">{item.desc}</span>
                  </div>
                </motion.div>
              ))}
            </motion.div>
